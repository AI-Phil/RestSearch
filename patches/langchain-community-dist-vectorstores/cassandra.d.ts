...
export declare class CassandraStore extends VectorStore {
     ...
     */
    similaritySearchVectorWithScore(query: number[], k: number, filter?: WhereClause, includeEmbedding?: boolean): Promise<[Document, number][]>;
    /**
     ...
     */
    static getClient(args: ClientArgs): Promise<CassandraClient>;
    static getAstraClient(args: ClientArgs): Promise<CassandraClient>;
}
